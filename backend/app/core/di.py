...
Adding a new scoring factor (e.g. flood risk) means adding a new
IScoreContributor and appending it to the CompositeHeatmapScorer list below -
ProjectProximityContributor/PoiProximityContributor/HazardPenaltyContributor
never need to change for that.
"""
